...
function EventCard({ title, gridSet }: { title: string, gridSet?: string }) {
    return (
        <div className={`hover:bg-cyan-50 hover:opacity-5 hover:cursor-pointer border-2 border-white relative flex justify-center items-center ${gridSet}`}>
...
function BigArrowImage() {
    return <div className="hover:bg-cyan-50 cursor-pointer border-2 border-white row-span-2 col-span-1 flex justify-center">
